        ...
        <div class="upper-side-container">
            <div class="upper-side">
                <div class="upper-side-title">
                    ...
                    <h1 id="Proveedores-title">Proveedores</h1>
                </div>
                <div class="upper-side-utilities">
                    <div class="utilities-searchbar">
                        ...
                        <input id="busqueda" type="search" placeholder="Buscar proveedor por nombre">
                    </div>
                    <span>
                        <button class="Agregar" onclick="window.location.href = 'registroProveedor.jsp';">
                            Agregar Proveedor
                        </button>
                    </span>
                </div>
        ...
        <table>
            ...
            <% 
                ...
                try {
                    ...
                    String sql = "SELECT * FROM distribuidor ORDER BY Dis_Cod";
                    stmt = conn.createStatement();
                    rs = stmt.executeQuery(sql);

                    // Iterar sobre los resultados y generar filas de la tabla
                    while (rs.next()) {
                    	String id = rs.getString("Dis_Cod");
                    	String nombre = rs.getString("Dis_Nombre");
                        String pais = rs.getString("Dis_Pais");
                        String telefono = rs.getString("Dis_Telefono");
                        String direccion = rs.getString("Dis_Direccion");
                    ...
                    e.printStackTrace();
                    out.println("<tr><td colspan='5'>Error al obtener los datos de la tabla Proveedores: " + e.getMessage() + "</td></tr>");
                } finally {
