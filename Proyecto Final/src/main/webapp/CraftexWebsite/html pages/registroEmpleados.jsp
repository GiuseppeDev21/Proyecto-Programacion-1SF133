...
<body>
    ...
    <main >
        <div class="upper-side-container">
            <div class="upper-side-title">
                <svg width="91" height="140" viewBox="0 0 91 140" fill="none" xmlns="http://www.w3.org/2000/svg" onclick="window.location.href='empleados.jsp';">
                ...
                <h1 id="Empleado-title"> Registro de Empleado</h1> <!-- TÃ­tulo principal de la secciÃ³n superior -->
            </div>
        </div>

        <!-- Título de la sección -->
        <h3 id="cliente-datos">Datos del empleado</h3>
        <hr id="bold-line">
        
        <div class="forms-container">
            <form action="registroEmpleados.jsp" METHOD="post">
                <div class="forms">
                    <div class="rows">
                        ...
                        <div class="row1-forms">
                            ...
                            <div class="form-group" id="cedula">
                                ...
                                <input type="text" id="cedula" name="cedula" placeholder="ej. 000000-000000-000000" required>
                            </div>
                        ...
                        <div class="row2-forms">
                            ...
                            <div class="form-group" id="cargo">
                                ...
                                <select id="profesion" name="profesion" required>
                                    ...
                                    <option value="4">Supervisor de Almacén</option>
                                    <option value="5">Especialista en Logística</option>
                                    <option value="6">Asistente Administrativo</option>
                                    <option value="7">Jefe de Compras</option>
                                    <option value="8">Técnico de Mantenimiento</option>
                                    <option value="9">Encargado de Inventario</option>
                                    <option value="10">Atención al Cliente</option>
                                </select>
                            </div>
                        </div>
                        <!-- Tercera fila del formulario -->
                        <div class="row3-forms">
                            <div class="form-group" id="direccion">
                                ...
                                <div class="inputs">
                                    ...
                                    <input type="text" id="ciudad" name="cuidad" placeholder="Ciudad" required>
                ...
                <div class="options">
                    ...
                    <button type="button" class="button-cancel" onclick="window.location.href = 'empleados.jsp';">Cancelar registro</button>
                </div>
            </form>
        </div>
    </main>
    ...
    <% 
            ...
            if (nombre != null && apellido != null && cedula != null && departamento != null && profesion!= null && correo != null && telefonoPersonal != null && provincia != null && ciudad != null && calle != null) {
                // Dirección completa
                ...
                try {
                    ...
                    stmt.setString(6, profesion);
                    stmt.setString(7, departamento);
                    stmt.setInt(8, 2); // El 2 es el tipo de telefono en la BD 'celular'
                    stmt.setString(9, telefonoPersonal);
                    ...
                    e.printStackTrace();
                    out.println("<p>Error al registrar el empleado: " + e.getMessage() + "</p>");
                } finally {
